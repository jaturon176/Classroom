...
export const CLOUDINARY_CONFIG = {
  ...
  uploadUrl: 'https://api.cloudinary.com/v1_1/gibfwtj2/image/upload'
};
...
export async function uploadImageToCloudinary(file, maxWidth = 1200, quality = 0.8) {
  ...
  try {
    ...
    // 3. Upload to Cloudinary CDN (Cloud Name: gibfwtj2)
    ...
    if (response.ok) {
      ...
      if (data.secure_url) {
        console.log('🖼️ Cloudinary CDN upload success (gibfwtj2):', data.secure_url);
