/**
 * Main Application Controller & Router (With Cache-Busting Version Query v=3.0)
...
import { RBACModule } from './modules/rbac.js?v=3.0';
import { DashboardModule } from './modules/dashboard.js?v=3.0';
import { StudentsModule } from './modules/students.js?v=3.0';
import { HomeworkModule } from './modules/homework.js?v=3.0';
import { QuizModule } from './modules/quiz.js?v=3.0';
import { AttendanceModule } from './modules/attendance.js?v=3.0';
import { GradebookModule } from './modules/gradebook.js?v=3.0';
import { SettingsModule } from './modules/settings.js?v=3.0';
import { syncEngine } from './services/syncEngine.js?v=3.0';
import { decodeMojibakeThai } from './services/mojibakeDecoder.js?v=3.0';
