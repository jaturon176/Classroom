...
import { RBACModule } from './modules/rbac.js?v=9.2';
import { DashboardModule } from './modules/dashboard.js?v=9.2';
import { StudentsModule } from './modules/students.js?v=9.2';
import { HomeworkModule } from './modules/homework.js?v=9.2';
import { QuizModule } from './modules/quiz.js?v=9.2';
import { AttendanceModule } from './modules/attendance.js?v=9.2';
import { GradebookModule } from './modules/gradebook.js?v=9.2';
import { SettingsModule } from './modules/settings.js?v=9.2';
import { syncEngine } from './services/syncEngine.js?v=9.2';
import { decodeMojibakeThai } from './services/mojibakeDecoder.js?v=9.2';
